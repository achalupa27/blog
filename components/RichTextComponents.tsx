...
export const RichTextComponents = {
    ...
    block: {
        ...
        blockquote: ({ children }: any) => <blockquote className='my-5 border-l-4 border-l-amber-500 py-5 pl-5'>{children}</blockquote>,
    },
    marks: {
        link: ({ children, value }: any) => {
            ...
            return (
                <Link href={value.href} rel={rel} className='underline decoration-amber-500 hover:decoration-black'>
                    {children}
                </Link>
            );
        },
